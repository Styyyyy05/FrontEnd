...
watch(
  ...
  (newUser) => {
    if (newUser?.role === 'admin') {
      fetchDashboardData()
      setTimeout(() => getResidentStatistic(), 300)
    }
...
<template>
  <div id="Dashhoard-admin" v-if="user?.role === 'admin'">
    <h1 class="font-semibold text-2xl mb-4">Desa Statistics</h1>
    <div id="Row-1" class="flex gap-[14px] mb-4">
      <div
    ...
    <div id="Row-2" class="flex gap-[14px] mb-4">
      <section
        id="Bantuan-Sosial"
    ...
    <div id="Row-3" class="flex gap-[14px] mb-4">
