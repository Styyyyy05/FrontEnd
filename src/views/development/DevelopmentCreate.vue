        ...
        <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                ...
                <div class="flex-1 flex items-center justify-between">
                    <div id="Photo-Preview"
                        ...
                        <img id="Photo" :src="development.thumbnail_url" alt="image" class="size-full object-cover"
                            v-if="development.thumbnail_url" />
                    </div>
                    <div class="relative">
            ...
            <section id="Nama-Projek" class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <Input v-model="development.name" type="text" placeholder="Ketik name Kamu"
            ...
            <section id="Penanggung-Jawab" class="flex items-center justify-between">
                ...
                <div class="flex flex-col gap-3 flex-1 shrink-0">
                    <Input v-model="development.person_in_charge" type="text"
                        placeholder="Ketik Penanggung Jawab Pembangunan" :error-message="error?.person_in_charge"
                ...
                <div class="flex items-center gap-6 flex-1 shrink-0">
                    <label class="relative group peer w-full">
                        <Input v-model="development.start_date" type="date" placeholder="Pilih Tanggal Awal "
                            :error-message="error?.start_date" :icon="IconCalendarSecondaryGreen"
